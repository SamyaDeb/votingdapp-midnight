...
```
├── voting-cli/         # CLI tools
├── voting-contract/    # Smart contracts
...
1. **Create .env file from template under voting-cli folder**
   - [`voting-cli/.env_template`](./voting-cli/.env_template)
